  ...
  function($scope, $location, $routeParams, Config, SweetAlert) {
    ...
    $scope.main = function() {
      ...
      if (!mxClient.isBrowserSupported()) {
        ...
        $scope.editor.addAction('export', function(editor, cell) {
          ...
          showModalWindow($scope.graph, 'XML', textarea, 410, 440);
          getInstructions();
        });
        var toolbar = document.getElementById('toolbarContainer');
        addToolbarButton($scope.editor, toolbar, 'export', 'Export', 'images/export1.png');
